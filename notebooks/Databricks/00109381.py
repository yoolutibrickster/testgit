...
dbutils.fs.put("s3://bi-businessintelligence/databricks_scripts/custom-cert.sh", """#!/bin/bash
...
# MAGIC %sh
# MAGIC openssl s_client -connect beam-int-bi-replica.cwaigsulgh26.us-east-1.rds.amazonaws.com:3306